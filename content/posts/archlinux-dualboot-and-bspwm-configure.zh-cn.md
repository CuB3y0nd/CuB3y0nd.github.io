...
subtitle:
date: 2023-08-05T22:30:09+08:00
draft: false
author:
  name: CuB3y0nd
  link:
...
![](https://pic1.zhimg.com/80/v2-13e5b0d12c9703776bb0299a0f33ef20_720w.webp)

![](https://pic1.zhimg.com/80/v2-50c31765bca00d05edb453bca307ec48_720w.webp)

![](https://pic4.zhimg.com/80/v2-cd2462f2c41027531ee6c9013ec8fe8f_720w.webp)

![](https://pic3.zhimg.com/80/v2-afbb403ca50b25e96f838e0ea4d98362_720w.webp)
...
`Win + R` 输入 `diskpart` 回车，在打开的命令行窗口中输入 `list disk` 指令，
输出结果如下：

![](https://pic2.zhimg.com/80/v2-33393697efed5f016943fcc94e8d5e3d_720w.webp)
...
如果发现无法从 U盘 启动，提示需要关闭 `Secure Boot` 的，请参考下面的方式关闭它
...
这是我的仓库地址：[1llusion](https://github.com/CuB3y0nd/1llusion)
